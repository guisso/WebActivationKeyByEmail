...
//        mail.setFrom("webappactivation@outlook.com");
        ...
        body.setContent(String.format(
                """
                <html>
                    <h1>System Key Activation</h1>
                    <h2>Hi, %s!</h2>
                    <p style="background-color: #eee; 
                    padding: .25em; border: solid #999 thin; 
                    border-left: solid #999 4px;">
                        Click <a href="%s" style="padding: 0 .25em; 
                        background-color: #ccc;">here</a>
                        to <b>activate</b> your account.
                    </p>
                </html>
                """, name, link),
